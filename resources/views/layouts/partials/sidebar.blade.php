    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ request()->is('admin/customers') || request()->is('admin/customers/*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.customers.index') }}">
                        <i class="fas fa-play-circle"></i> Todos los clientes</a>
                    </li>
                    <li><a href="{{ route('admin.customers.create') }}">
                        <i class="fas fa-plus-circle"></i> Añadir nuevo</a></li>
                </ul>
            </li>
            <li class="treeview {{ request()->is('admin/memberships') || request()->is('admin/memberships/*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.memberships.index') }}"><i class="fas fa-play-circle"></i> Administrar membresías</a></li>
                    <li><a href="{{ route('plans.index') }}"><i class="fas fa-plus-circle"></i> Añadir nueva</a></li>
                </ul>
            </li>
            <li class="treeview {{ request()->is('admin/plans') || request()->is('admin/plans/*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.plans.index') }}"><i class="fas fa-play-circle"></i> Administrar planes</a></li>
                    <li><a href="{{ route('admin.plans.create') }}"><i class="fas fa-plus-circle"></i> Añadir nuevo</a></li>
                </ul>
            </li>
            <li class="treeview {{ request()->is('admin/routines') || request()->is('admin/routines/*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.routines.index') }}"><i class="fas fa-play-circle"></i> Administrar rutinas</a></li>
                    <li><a href="{{ route('admin.routines.create') }}"><i class="fas fa-plus-circle"></i> Añadir nueva</a></li>
                </ul>
            </li>
            <li class="treeview {{ request()->is('admin/levels') || request()->is('admin/levels/*') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('admin.levels.index') }}"><i class="fas fa-play-circle"></i> Administrar niveles</a></li>
                    <li><a href="{{ route('admin.levels.create') }}"><i class="fas fa-plus-circle"></i> Añadir nuevo</a></li>
                </ul>
            </li>
